...
std_return_type MotorPwmInterfaceInit() {
	...
	HAL_TIM_PWM_Start_IT(&htim4, HAL_TIM_ACTIVE_CHANNEL_1);
	HAL_TIM_PWM_Start_IT(&htim4, HAL_TIM_ACTIVE_CHANNEL_2);
	HAL_TIM_PWM_Start_IT(&htim4, HAL_TIM_ACTIVE_CHANNEL_3);
